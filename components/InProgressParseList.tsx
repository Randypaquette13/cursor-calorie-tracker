...
function showFailedMenu(job: ParseJob, onRetry?: (id: number) => void, onDismiss?: (id: number) => void) {
  Alert.alert('Parse failed', job.errorMessage ?? 'Something went wrong.', [
        ...
        <View style={styles.section}>
          ...
          {failedJobs.map((job) => (
            <Pressable
              ...
              onPress={() => showFailedMenu(job, onRetry, onDismiss)}>
